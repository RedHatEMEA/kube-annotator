...
out: build origin
	...
	GOPATH=origin/Godeps/_workspace:origin/_output/local/go ./kube-annotator github.com/GoogleCloudPlatform/kubernetes/pkg/api/v1beta1 >out/kubernetes-v1beta2.txt
	...
	GOPATH=origin/Godeps/_workspace:origin/_output/local/go ./kube-annotator github.com/GoogleCloudPlatform/kubernetes/pkg/api/v1beta3 >out/kubernetes-v1beta2.txt
